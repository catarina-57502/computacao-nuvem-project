...
gcloud container clusters create cluster-steam --num-nodes 2 --zone europe-west4-a --node-locations europe-west4-a,europe-west4-b,europe-west4-c --enable-autoscaling --min-nodes 1 --max-nodes 4
